...
<div class="flex items-center gap-4">
    <button class="specialBtnDark" onclick="document.getElementById('my_modal_2').showModal()">Login</button>
      ...
      <div class="modal-box">
        ...
        <style type="text/css">
            ...
            <form action="" class="log-in" autocomplete="off"> 
              <h4>We are <span>BookEase</span></h4>
              <p>Welcome back! Log in to your account to book a celeb now!</p>
              <div class="floating-label">
                <input bind:value = {uusername} placeholder="Username"  name="email" id="email" autocomplete="off">
        ...
        <rect class="st0" width="100" height="100"/>
              ...
              <div class="floating-label">
                <input bind:value = {passwordd} placeholder="Password" type="password" name="password" id="password" autocomplete="off">
    ...
    <button class="specialBtnDark" onclick="document.getElementById('my_modal_3').showModal()">
        <p class="text-base sm:text-lg md:text-xl">SignUp &rarr;</p>
    </button>
    <dialog id="my_modal_3" class="modal">
        ...
        <style type="text/css">
            ...
            <form action="" class="log-in" autocomplete="off"> 
              <h4>We are <span>BookEase</span></h4>
              <p>Create a new account and book a celeb today!</p>
              <div class="floating-label">
                <input bind:value = {uusername} placeholder="Username"  name="email" id="email" autocomplete="off">
                <label for="email">Username:</label>
                <div class="icon">
